...
int showMainMenu() {
    ...
    cout << COLOR_OPTION << "  [3] Quit" << COLOR_RESET << endl;
    cout << COLOR_TITLE << "============================================" << COLOR_RESET << endl;
...
bool askPetChoice() {
    cout << endl << COLOR_TITLE << "============================================" << COLOR_RESET << endl;
...
int showPetMenu() {
    cout << endl << COLOR_CYAN << "--------------------------------------------" << COLOR_RESET << endl;
...
void displayStatus(const GameState& game, const SanityFatigue& sf) {
    ...
    cout << COLOR_TITLE << "============================================" << COLOR_RESET << endl << endl;
}
